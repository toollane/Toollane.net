...
export default function LtvCalculatorClient() {
  ...
  const result = useMemo(() => {
    ...
    const projection = [1, 3, 6, 12, 24, 36].map((month) => {
    ...
    <div className="grid gap-8">
      ...
      {!error && (
        <>
          ...
          <TogglePanel
            title="Retention and lifetime value projection"
            description="Open the detailed table to review retained customers, cumulative gross profit and CAC payback timing."
          >
