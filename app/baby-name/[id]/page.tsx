...
import { babyNames, getBabyNameById } from "@/data/baby-names";
...
export default async function BabyNamePage({ params }: Props) {
  ...
  const relatedLandingPages = babyNamePages
    ...
    .filter((page) => !page.slug.includes("starting-with"))
    .slice(0, 8);
            ...
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
              <div className="mb-8">
                ...
                <p className="mt-3 max-w-2xl text-black/60">
                  Explore baby name lists that match the gender, origin and
                  style of {name.name}.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="rounded-[2.5rem] border border-black/10 bg-white/75 p-8 shadow-sm backdrop-blur sm:p-12">
            ...
            <div className="mt-8 space-y-6 leading-8 text-black/65">
              ...
              <p>
                When choosing {name.name}, consider how it sounds with the
                family name, whether the meaning feels right and whether similar
                names or variants might also fit your preference.
              </p>
            </div>
          </div>
        </section>
          ...
          const targetPage = targetSlug
            ? babyNamePages.find(
                (page) =>
                  ...
                  !page.slug.includes("starting-with")
              )
            : undefined;
